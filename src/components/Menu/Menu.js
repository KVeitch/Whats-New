...
const Menu = (data) => {
  return <div className='navbar'>
    <ul className='btns-list'>
      <li className='btn' isActive='true' data-link='local' onClick={e => data.changeNewsFeed(e)}>
        <img data-link='local' src={location} className="icon" alt='line art of a location marker'/>
        Local News
      </li>
      <li className='btn' isActive='false' data-link='technology' onClick={e => data.changeNewsFeed(e)}>
        <img data-link='technology' src={technology} className="icon" alt='lightbulb with gears'/>
        Technology
      </li>
      <li className='btn' isActive='false' data-link='entertainment' onClick={e => data.changeNewsFeed(e)}>
        <img data-link='entertainment'src={entertainment} className="icon" alt='two tickes to a show'/>
        Entertainment
      </li>
      <li className='btn' isActive='false' data-link='science' onClick={e => data.changeNewsFeed(e)}>
        <img data-link='science' src={science} className="icon" alt='zooming rocketship'/>
        Science
      </li>
      <li className='btn' isActive='false' data-link='health' onClick={e => data.changeNewsFeed(e)}>
